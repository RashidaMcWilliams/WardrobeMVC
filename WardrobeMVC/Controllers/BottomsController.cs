...
namespace WardrobeMVC.Controllers
{
    public class BottomsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "BottomsID,BottomsName,BottomsType,BottomsColor,BottomsSeason,BottomsOccasion,BottomsPhoto")] Bottom bottom)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "BottomsID,BottomsName,BottomsType,BottomsColor,BottomsSeason,BottomsOccasion,BottomsPhoto")] Bottom bottom)
        {
            if (ModelState.IsValid)
            {
